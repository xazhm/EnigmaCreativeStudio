<html lang="en">
  ...
  <body>
    <header class="main_h sticky">
      <div class="row">
        <a class="logo" href="/index2">ENIGMA</a>
    ...
    <form action="/product-detail/{{$designs->slug}}" method="post" enctype="multipart/form-data">
        @csrf
            ...
            <div class="right-section">
                <div class="sidebar">
                    <div class="first-section">
                        <button class="raise" id="cta">Buy Design</button>
