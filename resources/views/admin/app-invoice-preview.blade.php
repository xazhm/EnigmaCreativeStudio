...
<html lang="en">
  <head>
    ...
    />
    <title>
      Invoice Preview | CORK - Multipurpose Bootstrap Dashboard Template
    </title>
    ...
    <link
      href="assets/src/assets/css/light/apps/invoice-preview.css"
      rel="stylesheet"
      type="text/css"
    />
    <link
      href="assets/src/assets/css/dark/apps/invoice-preview.css"
      rel="stylesheet"
      type="text/css"
    />
  ...
  <body class="layout-boxed">
                                  ...
                                  <div class="row">
                                    <div class="col-sm-6 col-12 mr-auto">
                                      <div class="d-flex">
                                        <img
                                          class="company-logo"
                                          src="assets/src/assets/img/cork-logo.png"
                                          alt="company"
                                        />
                                        <h3
    ...
    <script src="assets/src/assets/js/apps/invoice-preview.js"></script>
  </body>
</html>
