                ...
                <li class="nav-item dropdown language-dropdown">
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                                src="assets/src/assets/img/1x1/us.svg" class="flag-width" alt="flag" />
                            <span class="align-self-center">&nbsp;English</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                                src="assets/src/assets/img/1x1/tr.svg" class="flag-width" alt="flag" />
                            <span class="align-self-center">&nbsp;Turkish</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                                src="assets/src/assets/img/1x1/br.svg" class="flag-width" alt="flag" />
                            <span class="align-self-center">&nbsp;Portuguese</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                                src="assets/src/assets/img/1x1/in.svg" class="flag-width" alt="flag" />
                            <span class="align-self-center">&nbsp;Hindi</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                                src="assets/src/assets/img/1x1/de.svg" class="flag-width" alt="flag" />
                        ...
                        <div class="notification-scroll">
                            <div class="dropdown-item">
                                <div class="media server-log">
                                    <img src="assets/src/assets/img/profile-16.jpeg" class="img-fluid me-2"
                                        alt="avatar" />
                            ...
                            <div class="dropdown-item">
                                <div class="media">
                                    <img src="assets/src/assets/img/profile-15.jpeg" class="img-fluid me-2"
                                        alt="avatar" />
                                    <div class="media-body">
                                        <div class="data-info">
                            ...
                            <div class="dropdown-item">
                                <div class="media file-upload">
                                    <img src="assets/src/assets/img/profile-21.jpeg" class="img-fluid me-2"
                                        alt="avatar" />
                                    <div class="media-body">
                                        <div class="data-info">
        ...
        <div class="sidebar-wrapper sidebar-theme">
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        <a href="./charts-apex" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="authentication"
                            ...
                            <li>
                                <a href="./auth-boxed-2-step-verification" target="_blank">
                                    2 Step
                                </a>
                            </li>
                            <li>
                                    ...
                                    <div class="task-action">
                                        <div class="dropdown">
                                            <a class="dropdown-toggle" href="#" role="button"
                                                id="summary" data-bs-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                    height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                            ...
                                            <div class="dropdown-menu left" aria-labelledby="summary"
                                                style="will-change: transform">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="td-content customer-name">
                                                            <img src="assets/src/assets/img/profile-13.jpeg"
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="td-content customer-name">
                                                            <img src="assets/src/assets/img/profile-7.jpeg"
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="td-content customer-name">
                                                            <img src="assets/src/assets/img/profile-10.jpeg"
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="td-content customer-name">
                                                            <img src="assets/src/assets/img/profile-5.jpeg"
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="td-content customer-name">
                                                            <img src="assets/src/assets/img/profile-4.jpeg"
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="td-content customer-name">
                                                            <img src="assets/src/assets/img/profile-11.jpeg"
