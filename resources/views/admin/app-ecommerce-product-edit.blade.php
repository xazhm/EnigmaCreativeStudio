...
<html lang="en">
  <head>
    ...
    />
    <title>
      Ecommerce Edit | CORK - Multipurpose Bootstrap Dashboard Template
    </title>
  ...
  <body class="">
          ...
          <div class="middle-content container-xxl p-0">
            ...
            <div class="row mb-4 layout-spacing layout-top-spacing">
                  ...
                  <div class="row mb-4">
                    <div class="col-sm-12">
                      ...
                      <div id="product-description">
                        Perspiciatis maxime facilis velit tenetur, iste expedita
                        in dignissimos iure aut excepturi sapiente eligendi
                        repellat. Lorem ipsum dolor sit amet consectetur,
                        adipisicing elit. Aut blanditiis assumenda doloremque
                        fugiat minima tempora!
                      </div>
                    </div>
                  </div>
              ...
              <div class="col-xxl-3 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="row">
                  <div
                    class="col-xxl-12 col-xl-8 col-lg-8 col-md-7 mt-xxl-0 mt-4"
                  >
                    <div
                      class="widget-content widget-content-area ecommerce-create-section"
                    >
                        ...
                        <div class="col-xxl-12 mb-4">
                          ...
                          >
                            <input
                              ...
                              checked
                            />
                            <label class="switch-label" for="in-stock"
                              >In Stock</label
                            >
                          </div>
                        </div>
    ...
    <script>
      ecommerce.addFiles(
        "assets/src/assets/img/product-1.jpg",
        "assets/src/assets/img/product-3.jpg",
        "assets/src/assets/img/product-5.jpg"
      );
    </script>
